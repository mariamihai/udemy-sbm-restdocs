...
import guru.springframework.sbmrestdocs.web.model.BeerStyleEnum;
...
@ComponentScan(basePackages = "guru.springframework.sbmrestdocs.web.mapper")
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-post",
                                requestFields(
                                        ...
                                        fields.withPath("beerStyle").description("Style of Beer").type(BeerStyleEnum.class),
